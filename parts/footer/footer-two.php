                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                                <div class="footer-widget-two__about">
                                    ...
                                    <p class="footer-widget-two__about-text">Charity and donation is category that
                                        <br> involves giving.</p>
                                    <form class="footer-widget-two__form">
                            ...
                            <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                                <div class="footer-widget-two__links">
                                    ...
                                    <ul class="footer-widget-two__links-list list-unstyled">
                                        ...
                                        <li><a href="about.php">Our Blog</a></li>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                                <div class="footer-widget-two__services">
                                    ...
                                    <ul class="footer-widget-two__links-list list-unstyled">
                                        <li><a href="about.php">Emergency Relief</a></li>
                                        <li><a href="about.php">Medical Outreach</a></li>
                                        <li><a href="about.php">Educational Support</a></li>
                                        <li><a href="about.php">Mental Health</a></li>
                                        <li><a href="about.php">Community Development</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="site-footer-two__bottom-inner">
                                <div class="site-footer-two__copyright">
                                    <p class="site-footer-two__copyright-text">© 1995-2025 All rights for <a
                                            href="#">Chioary</a>
                                        exclusive</p>
                                </div>
